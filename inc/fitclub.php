...
function fitclub_custom_css() {
	...
	if( $primary_color != '#32c4d1' ) {
		...
		#site-navigation ul li > a:before,#site-navigation ul li > a:before,
		.slider-caption-wrapper .caption-title::after,.tribe-events-list-widget .section-title,
		.tribe-events-list-widget .section-title::after,.tribe-events-list-widget .tribe-events-widget-link ,
