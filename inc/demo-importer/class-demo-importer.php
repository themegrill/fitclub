...
/**
 * FitClub_Demo_Importer Class.
 */
class FitClub_Demo_Importer {
	...
	public function __construct() {
		$this->plugin_data = array(
			...
			'name' => __( 'ThemeGrill Demo importer', 'fitclub' ),
		);
	...
	public function add_admin_menu() {
		add_theme_page( __( 'Demo Importer', 'fitclub' ), __( 'Demo Importer', 'fitclub' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
	}
