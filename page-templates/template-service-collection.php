<?php
/**
 * Template Name: Service Collection Template
 *
 * Displays the page which use Service Template
 *
 * @package ThemeGrill
 * @subpackage FitClub
 * @since FitClub 1.0
...
<?php
	do_action( 'fitclub_before_body_content' );
			...
			<div class="tg-container">
				<div id="primary">
					...
					foreach ( $all_pages as $page_item ) {
						...
						if ( 'page-templates/template-service.php' === $template_name ) {
				...
				<div class="trainer-collecton-wrapper tg-column-wrapper">
						...
						<div class="trainer-collection tg-column-3 tg-column-bottom-margin">
							...
							if ( has_post_thumbnail() ) {
								...
								echo '<img src="' . esc_url( get_template_directory_uri() ) . '/images/placeholder-team.jpg">';
							}
							?>
							</figure>
